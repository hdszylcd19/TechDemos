...
import com.oneday.base.databinding.CustomPermissionDialogLayoutBinding
import com.oneday.base.databinding.CustomPermissionItemBinding
import com.permissionx.guolindev.dialog.RationaleDialogFragment

@TargetApi(30)
class CustomPermissionDialogFragment() : RationaleDialogFragment() {
    ...
    private var mPermissions: List<String> = emptyList()

    private val groupSet = HashSet<String>()

    private var _binding: CustomPermissionDialogLayoutBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = CustomPermissionDialogLayoutBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun buildPermissionsLayout() {
        for (permission in mPermissions) {
            ...
            if (permissionGroup != null && !groupSet.contains(permissionGroup)) {
                val itemBinding = CustomPermissionItemBinding.inflate(
                    layoutInflater,
